// 从配置文件中获取 umami 的配置
const website_id = CONFIG.web_analytics.umami.data_website_id;
// 拼接请求地址
const request_url =
  CONFIG.web_analytics.umami.api_server +
  "/api/websites/" +
  website_id +
  "/stats";
const start_time = new Date(CONFIG.web_analytics.umami.start_time).getTime(); // 转换为 Unix 时间戳
